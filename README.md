...
![ELS-Pulse Demo](assets/els_pulse_ensemble_audit_full_demo.mp4)
...
| Performance Auditor | Neural Heatmap | Brand Insights |
| :---: | :---: | :---: |
| ![Performance](assets/els_pulse_performance_auditor.png) | ![Heatmap](assets/els_pulse_neural_heatmap.png) | ![Insights](assets/els_pulse_brand_monitoring_insights.png) |
...
* **Project development/**: Core application (`app.py`), development notebook (`sentiment analysis.ipynb`), and training datasets.
* **models/**: Serialized `.pkl` files for all classifiers and the TF-IDF vectorizer.
* **Project Summary/**: Executive overview titled *SENTIMENT ANALYSIS FOR BRAND MONITORING AND COMPETITOR ANALYSIS.pdf*.
* **Research thesis/**: Comprehensive *PROJECT REPORT - SENTIMENT ANALYSIS FOR BRAND MONITORING AND COMPETITOR ANALYSIS.pdf*.
* **Research papers (Academic Reference Library)/**: 
    * *Artificial Intelligence and Sentiment Analysis A Review in.pdf*
    * *Comparative_Analysis_of_Machine_Learning.pdf*
    * *Sentiment analysis and social media analytics in brand management Techniques, Trends and Implications.pdf*
    * *Social Media Sentiment Analysis for Brand Reputation management.pdf*
    * *social-media-sentiment-analysis-for-brand-monitoring-IJERTV13IS100134.pdf*
